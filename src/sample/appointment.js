...
/**
 * @api {get} /appointment/query/byUser/:user_id Get Appointment By User
 * @apiName get appointment by user_id
 * @apiGroup Appointment
 *
...
function getAppointmentByUser() {
  console.log('GET Appointment by User');
  let user_id = '2660d148-a3bc-464f-8238-aefe4197326c';
  fetch(endPoint + '/appointment/query/byUser/' + user_id)
    .then(res => res.text())
    .then(body => {
      console.log(body);
      console.log('END');
...
/**
 * @api {get} /appointment/query/byClassroom/:classroom_id Get Appointment By User
 * @apiName get appointment by classroom_id
 * @apiGroup Appointment
 *
 * @apiParam {String} user_id User unique ID.
 * @apiParam {String} classroom_id Classroom unique ID.
 *
 * @apiSuccess {Object[]} data array of Appointment.
 * @apiSuccess {String} id id of the Appointment (pk).
 * @apiSuccess {String} appointment_id id of the Appointment (AI).
...
function getAppointmentByClassroom() {
  console.log('GET Appointment by Classroom');
  let classroom_id = 'a33110b8-6766-448b-9107-d4ce8ca710d4';
  fetch(endPoint + '/appointment/query/byClassroom/' + classroom_id)
    .then(res => res.text())
    .then(body => {
      console.log(body);
      console.log('END');
...
/**
 * @api {post} /appointment/query/byUserAndClassroom Get Appointment By User And Classroom
 * @apiName get appointment by user_id and classroom_id
 * @apiGroup Appointment
 *
 * @apiParam {String} classroom_id Classroom unique ID.
 *
...
function getAppointmentByUserAndClassroom() {
  ...
  fetch(endPoint + '/appointment/query/byUserAndClassroom', {
    method: 'POST',
